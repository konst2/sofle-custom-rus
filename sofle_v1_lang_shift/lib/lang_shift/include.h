...
enum lang_shift_keycodes {
    ...
    SFT_STK, /* Залипающий шифт. Работает как обычный. Но если просто нажать и отпустить то применится к следующей клавише. */
    ...
    LA_CRBN, /* Задаёт переключение языка на Carabiner. F18 - русский, F19 - английский */
